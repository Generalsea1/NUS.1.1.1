...
class _NusCopilotPageState extends State<NusCopilotPage> {
  ...
  Future<AiInsightRequest> _buildRequest(String question) async {
    ...
    try {
      ...
      final lists = await SupabaseHouseholdShoppingRepository(
    ...
    return NusAiContextComposer.compose(
      objective: 'أنت NUS Copilot. ساعد المستخدم في تنظيم حياته وبيته باستخدام الحقائق المعروضة فقط. افصل FACTS عن ADVICE. لا تخترع أرقامًا، ولا تنفذ أو تقترح تنفيذ كتابة بيانات. أجب بالمصرية الواضحة. سؤال المستخدم: $question',
      context: context,
            ...
            children: [
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        'Copilot يقرأ سياقًا محدودًا من البيت والمواعيد والمشتريات والمال. لا يكتب أي بيانات ولا ينفذ إجراءً من تلقاء نفسه.',
                      ),
                    ],
                  ),
                ),
              ...
              if (_loadingContext)
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 12),
                        Expanded(child: Text('بجهز سياق البيت…')),
                      ],
                    ),
                  ),
                )
                ...
                if (_loadingAnswer)
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          CircularProgressIndicator(),
                          SizedBox(height: 12),
                          Text('NUS بيجمع الحقائق وبيجهز الرد…'),
                        ],
                      ),
                    ),
                  )
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 10),
                          Text(
                            'المحتوى مبني على سياق محدود ومصادر قراءة فقط.',
                  ...
                  const Card(
                    key: ValueKey<String>('copilot-empty-state'),
                    child: Padding(
                      padding: EdgeInsets.all(18),
                      child: Text(
                        'اكتب سؤالك، وNUS هيرد باستخدام الحقائق المتاحة فقط.',
                      ),
                    ),
                  ),
              ],
