...
class Nus2App extends StatefulWidget {
  const Nus2App({super.key, required this.store, required this.medicationService, required this.shoppingService, required this.expenseService});
...
class _Nus2AppState extends State<Nus2App> {
  ...
  ThemeData _theme(Brightness brightness) => ThemeData(
    ...
    scaffoldBackgroundColor: brightness == Brightness.dark ? const Color(0xFF0B0D14) : const Color(0xFFF6F7FB),
