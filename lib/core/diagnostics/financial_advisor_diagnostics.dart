...
class FinancialAdvisorDiagnostics extends ChangeNotifier {
  ...
  String _sanitize(String value) {
    ...
    result = result.replaceAll(RegExp(r'(?i)(api[_-]?key\s*[=:]\s*)[^\s,]+'), r'\1[REDACTED]');
    result = result.replaceAll(RegExp(r'(?i)(access[_-]?token\s*[=:]\s*)[^\s,]+'), r'\1[REDACTED]');
    result = result.replaceAll(RegExp(r'(?i)(refresh[_-]?token\s*[=:]\s*)[^\s,]+'), r'\1[REDACTED]');
    result = result.replaceAll(RegExp(r'(?i)(cookie\s*[=:]\s*)[^\s,]+'), r'\1[REDACTED]');
    return result;
  }
}
