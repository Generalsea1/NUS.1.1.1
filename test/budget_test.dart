...
void main() {
  test('budget uses exact minor units and deterministic serialization', () {
    final budget = Budget(id: 'b1', name: 'Food', limitMinorUnits: 50000, currencyCode: 'usd', periodStart: DateTime(2026, 9, 1), periodEnd: DateTime(2026, 9, 30), categoryId: 'food');
  ...
  test('budget rejects invalid money, currency and period', () {
    expect(() => Budget(id: '', name: 'x', limitMinorUnits: 1, currencyCode: 'USD', periodStart: DateTime(2026), periodEnd: DateTime(2026)), throwsArgumentError);
    expect(() => Budget(id: 'b', name: 'x', limitMinorUnits: 0, currencyCode: 'USD', periodStart: DateTime(2026), periodEnd: DateTime(2026)), throwsArgumentError);
    expect(() => Budget(id: 'b', name: 'x', limitMinorUnits: 1, currencyCode: 'US', periodStart: DateTime(2026), periodEnd: DateTime(2026)), throwsArgumentError);
  ...
  test('budget consumption is derived from compatible transactions', () async {
    ...
    final budget = Budget(id: 'b', name: 'Food', limitMinorUnits: 2500, currencyCode: 'USD', periodStart: DateTime(2026, 9, 1), periodEnd: DateTime(2026, 9, 30), categoryId: 'food');
